...
void Child::publishConfig()
{
  ...
  switch (_elementType)
  {
    ...
    case E_TRIGGER:
      ...
      Jconfig["payload"] = String(_label); //"single";
      Jconfig["subtype"] = String(_label); //"single";
      Jconfig["topic"] = String(HAlora2ha) + "/"  + String(hub.getUniqueId()) + "/" + String(_HAuid) + "/action";
      Jconfig["type"] = "action";
      break;
    case E_EVENT:
      topic += "event";
  ...
  if (_elementType == E_TRIGGER)
  {
    topic += "/" + String(hub.getUniqueId()) + "/action_single_" + String(_HAuid) + "/config";
  } else {
...
void Child::publishState()
{
  ...
  switch (_elementType)
  {
    ...
    case E_SELECT:
      ...
      break;
    case E_TRIGGER:
      topic = String(HAlora2ha) + "/" + String(hub.getUniqueId()) + "/" + String(_HAuid) + "/action";
      payload = String(_label); //"single";
      retained = false;
      break;
    case E_EVENT:
      payload = "press";
