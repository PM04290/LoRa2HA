...
void setup()
{
  ...
  deviceManager.addElement(new Binary(PIN_IN1, CHILD_ID_INPUT1, F("Contact 1"), stateInverted, nullptr));
  deviceManager.addElement(new Binary(PIN_IN2, CHILD_ID_INPUT2, F("Contact 2"), stateInverted, nullptr));
  deviceManager.addElement(new Binary(PIN_IN3, CHILD_ID_INPUT3, F("Contact 3"), stateInverted, nullptr));
