...
#define EEPROM_DATA_RANGE    3
#define EEPROM_DATA_NVPN     4
...
char private_key[65] = "";      // [Interface] PrivateKey
IPAddress local_ip(1,2,3,4);    // [Interface] Address
char public_key[65] = "";       // [Peer] PublicKey
char endpoint_address[16] = ""; // [Peer] Endpoint
int endpoint_port = 48123;      // [Peer] Endpoint
