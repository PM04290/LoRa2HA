...
.\bin\esptool.exe --chip esp32s2 --port COM%usedcom% --baud 921600 --before default_reset --after no_reset write_flash -z --flash_mode dio --flash_freq 80m --flash_size 4MB 0x1000 ./bin/S2.bootloader.bin 0x8000 ./bin/S2.partitions.bin 0xe000 ./bin/boot_app0.bin 0x10000 ../lora2ha-HUB-V1-3.ino.lolin32.bin
pause
