...
.\bin\esptool.exe --chip esp32 --port COM%usedcom% --baud 921600 --before default_reset --after no_reset write_flash -z --flash_mode dio --flash_freq 80m --flash_size 4MB 0x1000 ./bin/WROOM.bootloader.bin 0x8000 ./bin/WROOM.partitions.bin 0xe000 ./bin/boot_app0.bin 0x10000 ../lora2ha-HUB-V1-1.ino.esp32-poe-iso.bin
pause
